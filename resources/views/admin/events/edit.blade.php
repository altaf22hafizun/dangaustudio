...
@section('title', 'Edit Event | Admin Dangau Studio')
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_event" id="nama_event"
                                ...
                                placeholder="Masukkan judul Event" value="{{ old('nama_event', $events->nama_event) }}">
                            @error('nama_event')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="location" id="location"
                                ...
                                placeholder="Masukkan lokasi Event" value="{{ old('location', $events->location) }}">
                            @error('location')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="category" id="category"
                                ...
                                placeholder="Masukkan kategori Event" value="{{ old('category', $events->category) }}">
                            @error('category')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status_publikasi" class="form-control rounded-0 @error('status_publikasi') is-invalid @enderror">
                                @foreach ($status_publikasi as $key => $status)
                                    <option value="{{ $key }}" {{ old('status_publikasi', $events->status_publikasi) == $key ? 'selected' : '' }}>
                                        {{ $status }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="editor" name="description"
                                ...
                                placeholder="Masukkan isi event">{{ old('description', $events->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
