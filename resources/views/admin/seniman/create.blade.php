...
@section('title', 'Tambah Seniman | Admin Dangau Studio')
@section('menuSeniman','active')
@section('content')

<div class="card">
    <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Tambah Seniman</h5>
        <form action="{{ route('seniman.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                     <!-- Judul Seniman -->
                     <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            placeholder="Masukkan nama Seniman" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="telp" id="telp"
                            ...
                            placeholder="Masukkan bahan Seniman" value="{{ old('telp') }}">
                        @error('telp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="medsos" id="medsos"
                            ...
                            placeholder="Masukkan instagram Seniman" value="{{ old('medsos') }}">
                        @error('medsos')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="editor" name="bio"
                            ...
                            placeholder="Masukkan isi Seniman">{{ old('bio') }}</textarea>
                        @error('bio')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
