...
@section('title', 'Tambah Pameran | Admin Dangau Studio')
@section('menuPameran','active')
@section('content')

<div class="card">
    <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Tambah Pameran</h5>
        <form action="{{ route('pameran.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- Kolom pertama -->
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_pameran" id="name_pameran"
                            ...
                            placeholder="Masukkan judul Pameran" value="{{ old('name_pameran') }}">
                        @error('name_pameran')
                ...
                <div class="col-lg-12">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="editor" name="description"
                            ...
                            placeholder="Masukkan isi Pameran">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
...
<script>
    function previewImage() {
        ...
        oFReader.onload = function(oFRPameran) {
            imgPreview.src = oFRPameran.target.result;
        }
    }
</script>
@endpush
