...
@section('title', 'Tambah Karya | Admin Dangau Studio')
@section('menuKarya','active')
@section('content')

<div class="card">
    <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Tambah Karya</h5>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            placeholder="Masukkan nama Karya" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="medium" id="medium"
                            ...
                            placeholder="Masukkan bahan Karya" value="{{ old('medium') }}">
                        @error('medium')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="price" id="price"
                            ...
                            placeholder="Masukkan harga Karya" value="{{ old('price') }}">
                        @error('price')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="tahun" id="tahun"
                            ...
                            placeholder="Masukkan harga Karya" value="{{ old('tahun') }}">
                        @error('tahun')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="seniman_id" id="seniman_id"
                            ...
                            @foreach ($senimans as $seniman)
                                <option value="{{ $seniman->id }}" {{ old('seniman_id') == $seniman->id ? 'selected' : '' }}>
                                    {{ $seniman->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="size" id="size"
                            ...
                            placeholder="Masukkan ukuran Karya" value="{{ old('size') }}">
                        @error('size')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="pameran_id" id="pameran_id"
                            ...
                            @foreach ($pamerans as $pameran)
                                <option value="{{ $pameran->id }}" {{ old('pameran_id') == $pameran->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="editor" name="deskripsi"
                            ...
                            placeholder="Masukkan isi Karya">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
