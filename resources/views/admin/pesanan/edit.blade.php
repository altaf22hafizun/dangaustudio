                ...
                <div class="col-lg-6">
                   ...
                   {{-- <!-- Nama Karya -->
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control rounded-0 @error('name') is-invalid @enderror" readonly value="{{ old('name', $namaKaryaString) }}">
                        @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="resi_pengiriman" id="resi_pengiriman"
                            class="form-control rounded-0 @error('resi_pengiriman') is-invalid @enderror"
                            placeholder="Masukkan Resi Pengiriman"
                            value="{{ old('resi_pengiriman', $pesanans->resi_pengiriman) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="jenis_pengiriman" id="jenis_pengiriman"
                            class="form-control rounded-0 @error('jenis_pengiriman') is-invalid @enderror"
                            readonly
                            value="{{ old('jenis_pengiriman', $pesanans->jenis_pengiriman) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="ongkir" id="ongkir"
                            class="form-control rounded-0 @error('ongkir') is-invalid @enderror"
                            readonly
                            value="{{ old('ongkir', $pesanans->ongkir) }}">
                        @error('ongkir')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" id="status"
                            class="form-control rounded-0 @error('status') is-invalid @enderror">
                            <option value="" disabled selected>-- Pilih Status --</option>
                            @foreach ($status as $stat)
                                <option value="{{ $stat }}" {{ old('status', $pesanans->status) == $stat ? 'selected' : '' }}>
                                    {{ $stat }}
                                </option>
                            @endforeach
                        </select>
